...
export const QUESTION_BANK: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "C = ε₀A/d = (8.85×10⁻¹²)(100×10⁻⁴)/(2×10⁻³) = 4.43 pF",
    difficulty: "Moderate",
    type: "MCQ",
    examType: ["JEE"],
  },
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "After 3 half-lives: (1/2)³ = 1/8 of the original amount remains.",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["NEET", "JEE"],
    year: 2022,
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Mitochondria produce ATP through cellular respiration (oxidative phosphorylation), hence called the powerhouse.",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["NEET", "BOARD"],
    year: 2023,
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Tt × Tt gives: TT (25%), Tt (50%), tt (25%). So Tt genotype = 50%",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["NEET", "BOARD"],
  },
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Pepsin, secreted as pepsinogen and activated by HCl in the stomach, begins protein digestion.",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["NEET"],
    year: 2022,
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Standard form: (x-h)² + (y-k)² = r². With h=2, k=-3, r=4: (x-2)² + (y+3)² = 16",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["JEE", "BOARD"],
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "For equal roots, discriminant = 0. b² - 4ac = 25 - 8k = 0 → k = 25/8",
    difficulty: "Moderate",
    type: "MCQ",
    examType: ["JEE"],
  },
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "For l=3 (f subshell), m ranges from -3 to +3 (7 values). Each orbital holds 2 electrons: 2 × 7 = 14 electrons.",
    difficulty: "Moderate",
    type: "MCQ",
    examType: ["NEET", "JEE"],
    year: 2020,
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Phytoplankton are photosynthetic organisms that form the base of the aquatic food chain (primary producers).",
    difficulty: "Easy",
    type: "MCQ",
    examType: ["NEET"],
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "B = μ₀I/2r = (4π×10⁻⁷ × 5)/(2 × 0.1) = 10π × 10⁻⁶ T = 10π μT",
    difficulty: "Moderate",
    type: "MCQ",
    examType: ["JEE", "NEET"],
  },
...
export function getQuestions(
  ...
  if (filtered.length < count) {
    const extras = QUESTION_BANK.filter(
      (q) => !filtered.find((f) => f.id === q.id)
